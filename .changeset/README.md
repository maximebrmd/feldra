...
Run `npm run changeset` from the repository root. Select `create-saas-keel`, choose patch/minor/major and describe the user-visible change. Template changes in apps or shared packages also belong to the initializer release because they are bundled in it.
