...
> Feldra é o novo nome do projeto. O repositório no GitHub é `maximebrmd/feldra`. O inicializador é `create-feldra`. Seu comando público no npm fica disponível após a publicação.
