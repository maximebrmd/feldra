...
description: "Neon or Supabase. The same Postgres foundation."
sidebar:
  order: 4
---
...
Fill in authentication and Stripe values as described in [setup](/docs/environment/), then run from the generated project root:
