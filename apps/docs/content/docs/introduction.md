...
> Feldra is the project’s new name. The GitHub repository is `maximebrmd/feldra`. The initializer package is `feldra`. After publication, run `npx feldra` or `npm exec feldra`.
