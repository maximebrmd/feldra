...
> Feldra ist der neue Name des Projekts. Das GitHub-Repository ist `maximebrmd/feldra`. Das Initializer-Paket heißt `feldra`. Nach der Veröffentlichung: `npx feldra` oder `npm exec feldra`.
